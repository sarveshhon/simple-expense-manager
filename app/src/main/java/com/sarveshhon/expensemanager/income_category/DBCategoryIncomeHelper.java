...
public class DBCategoryIncomeHelper extends SQLiteOpenHelper {

    // This contains all the details about IncomeCategory Table
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "DBM";
    private static final String TABLE_CATEGORY = "IncomeCategory";
    private static final String KEY_ID = "id";
    private static final String KEY_NAME = "title";

    public DBCategoryIncomeHelper(Context context) {

        super(context, DATABASE_NAME, null, DATABASE_VERSION);

    }

    // This onCreate() method creates Table IncomeCategory in Database
    @Override
    ...
    // This onUpgrade() method will upgrade IncomeCategory
    ...
    // its adds new Category type in IncomeCategory Table
    ...
    // This method will return list of all the Categories in IncomeCategory Table
